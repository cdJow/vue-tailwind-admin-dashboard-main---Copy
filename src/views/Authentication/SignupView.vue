  ...
  <template>
    ...
    <div
    class="  rounded-sm border border-stroke bg-white shadow-default sm:p-0 sm:my-0  dark:border-strokedark dark:bg-boxdark w-full sm:w-70 lg:w-1/4 xl:w-[1000px]  mx-auto my-auto"
  >
  <div class="flex flex-wrap items-center">
    ...
    <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
      <div class="w-full p-4 sm:p-2 xl:p-17.5">
        ...
        <h2 class="mb-2 text-2xl font-bold text-black dark:text-white sm:text-title-xl">
      SING UP
        </h2>
        <form>
