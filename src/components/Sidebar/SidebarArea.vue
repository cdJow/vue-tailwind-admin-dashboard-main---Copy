...
<template>
  <header class="sticky top-0 z-100 flex w-full shadow-lg p-4 lg:fixed bg-gradient-to-r from-red to-orange-600">
    <!-- Use justify-between to push the DropdownUser to the right -->
    <nav class="flex w-full justify-between items-center">
      <div class="flex gap-2">
        <template v-for="menuGroup in menuGroups" :key="menuGroup.name">
          <ul class="flex text-white items-center gap-6">
            <SidebarItem
