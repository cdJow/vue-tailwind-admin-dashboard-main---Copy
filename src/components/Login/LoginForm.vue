...
export default defineComponent({
  ...
  setup() {
    ...
    const handleLogin = () => {
      // Navigate directly to the 'eCommerce' route
...
<template>
  ...
  <div
     class="  rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark w-full sm:w-70 lg:w-1/4 xl:w-[1000px] mx-auto mt-10"
  >
      ...
      <div class="w-full xl:block xl:w-1/2">
        <div class="py-9 px-6 text-center">
          ...
          <span class="mt-9 inline-block">
            <!-- Image: adjust width for mobile to make it smaller -->
       ...
       LOG IN
          ...
          <form  @submit.prevent="handleLogin">
            ...
            <div class="mt-6 text-center">
              <p class="font-medium">
                Don’t have any account? <a href="/auth/SignUp" class="text-primary">Sign up</a>
              </p>
            </div>
          </form>
        </div>
