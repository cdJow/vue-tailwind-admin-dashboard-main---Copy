...
<template>
  ...
  >
    <div class="mr-5 flex h-9 w-full max-w-[36px] items-center justify-center rounded-lg bg-[#34D399] z-999">
      <svg
        width="16"
        height="12"
        viewBox="0 0 16 12"
...
.success-message {
  ...
  background-color: #a1ffdd !important; /* Solid background without opacity */
  padding: 1rem;
